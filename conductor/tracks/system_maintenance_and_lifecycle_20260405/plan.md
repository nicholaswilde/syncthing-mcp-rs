...
## Phase 2: MCP Tools Implementation [checkpoint: bfd2688]
- [ ] Task 2.1: Create new tool `check_upgrade` in `src/tools/`
- [ ] Task 2.2: Create new tool `perform_upgrade` in `src/tools/`
- [ ] Task 2.3: Create new tool `ping_instance` in `src/tools/`
- [ ] Task 2.4: Register tools in `src/tools/mod.rs`
