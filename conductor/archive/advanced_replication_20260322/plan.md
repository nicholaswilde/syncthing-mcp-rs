...
## Phase 4: Validation
- [x] Task: Unit tests for selective replication logic with mock configurations. 5c0a74c
- [x] Task: Integration tests verifying `dry_run` behavior. 7ae15d6
- [x] Task: Test complex replication scenarios involving multiple folders and devices. 5c0a74c
